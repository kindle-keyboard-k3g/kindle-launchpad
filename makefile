...
CFLAGS = -I$(PRJ_DIR)/ -I$(PRJ_DIR)/include -msoft-float  -Wall -lpthread
...
# Target Directives
#------------------------------------
.PHONY: all clean kindle debug

all:	$(PROJ_NAME)

kindle:
	$(MAKE) BUILD_SPEC=Kindle CROSS_COMPILE?=arm-linux-gnueabi- all
...
clean:
	rm -rf bin/ binarm/ bindebug/ armdebug/
